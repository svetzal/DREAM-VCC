...
namespace VCC::Debugger
{
	...
	public:
		...
		static const inline std::array<OpCodeInfo, 256> Page1OpCodes =
		{ {
		...
		static const inline std::array<OpCodeInfo, 256> Page2OpCodes =
		{ {
		...
		static const inline std::array<OpCodeInfo, 256> Page3OpCodes =
		{ {
			{0x00,	"-",		Illegal,		0,		0,		0,		2,	false,	None},
			{0x01,	"-",		Illegal,		0,		0,		0,		2,	false,	None},
			{0x02,	"-",		Illegal,		0,		0,		0,		2,	false,	None},
		...
		static const inline std::map<std::string, IndexModeInfo, std::less<>> IndexingModes = 
		{ 
